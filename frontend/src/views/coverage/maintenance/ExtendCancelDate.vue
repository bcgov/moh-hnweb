<template>
  <AppHelp>
    ...
    <p>If the transaction is successful, the group member’s PHN is displayed. You may use the PHN with the Get Contract Periods screen to verify the cancellation date has been correctly changed.</p>
  </AppHelp>
