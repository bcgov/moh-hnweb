<template>
  <AppHelp>
    ...
    <p>
      ...
      <a href target="_blank">www.gov.bc.ca/mspgroupplanadministratorforms</a>), or submit a written request including your group number, employee account number(s) and name(s), and all the information required on the form to Health Insurance BC at: <br />PO Box 9140 <br />Stn Prov Govt<br />Victoria
      BC V8W 9E5
    </p>
