<template>
  <AppHelp>
    ...
    <p>If the transaction was successful, persons will be returned:</p>
    <p>the spouse(s), active and cancelled ·</p>
    <p>the dependent(s)</p>
    <p>the person whose PHN was entered on the input screen</p>
