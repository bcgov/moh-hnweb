...
export const PRIOR_RESIDENCES = [
  { text: 'Select', value: '' },
  { text: 'Alberta', value: 'AB' },
  { text: 'British Columbia', value: 'MB' },
  { text: 'Manitoba', value: 'NB' },
  { text: 'New Brunswick', value: 'NL' },
  { text: 'Newfoundland', value: 'NS' },
  { text: 'Northwest Territories', value: 'NT' },
  { text: 'Nova Scotia', value: 'NU' },
  { text: 'Nunavut', value: 'OC' },
  { text: 'Ontario', value: 'ON' },
  { text: 'P.E.I', value: 'PE' },
  { text: 'Quebec', value: 'QC' },
  { text: 'Saskatchewan', value: 'SK' },
  { text: 'Yukon', value: 'US' },
  { text: 'Other Country', value: 'YT' },
  { text: 'U.S.A', value: 'BC' },
]
