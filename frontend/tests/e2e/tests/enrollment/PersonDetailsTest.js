...
test('Check Date Of Death message validation', async (t) => {
  await t
    // Given I have a form filled out with data
    .typeText(PersonDetailsPage.phnInput, '9874359585')
    .wait(1000)
    // When I click the submit button
    .click(PersonDetailsPage.submitButton)
    // I expect an error message stating the page had errors for date of death
    .expect(AlertPage.alertBannerText.textContent)
    .contains(DATE_OF_DEATH_MESSAGE)
})
