...
test('Check invalid field validation', async (t) => {
  await t
    ...
    .typeText(AddVisaResidentWithPHNPage.address1Input, 'Test 111 ST is tooooooooooooooooooooooooooooo long')
    ...
    .typeText(AddVisaResidentWithPHNPage.mailingAddress1Input, 'Test 111 ST is tooooooooooooooooooooooooooooo long')
    .typeText(AddVisaResidentWithPHNPage.mailingAddress2Input, 'Test 111 ST @@@@@')
