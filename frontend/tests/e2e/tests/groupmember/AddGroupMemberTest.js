...
test.skip('Check clear button clears the form', async t => {	  
    await t
        ...
        .expect(AddGroupMember.phnInput.value).eql('')
        .expect(AddGroupMember.groupMemberNumberInput.value).eql('')
        .expect(AddGroupMember.departmentNumberInput.value).eql('')
        .expect(AddGroupMember.address1Input.value).eql('')
        .expect(AddGroupMember.address2Input.value).eql('')
        .expect(AddGroupMember.address3Input.value).eql('')
        .expect(AddGroupMember.address4Input.value).eql('')
        .expect(AddGroupMember.postalCodeInput.value).eql('')
        .expect(AddGroupMember.telephoneInput.value).eql('')
        .expect(AddGroupMember.mailingAddress1Input.value).eql('')
        .expect(AddGroupMember.mailingAddress2Input.value).eql('')
