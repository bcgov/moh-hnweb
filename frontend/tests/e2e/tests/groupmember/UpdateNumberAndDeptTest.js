...
test('Check required fields validation', async t => {
    await t
        ...
        .expect(AlertPage.alertBannerText.textContent).contains(GROUP_NUMBER_DEPARTMENT_REQUIRED_MESSAGE)  
...
test('Check properly filled form passes validation', async t => {
	await t
        ...
        .expect(UpdateNumberAndDept.phnOutput.exists).ok()
        .expect(UpdateNumberAndDept.updateAnotherButton.exists).ok()
})
