...
test('Check required fields validation', async (t) => {
  await t
    ...
    .expect(CoverageStatusCheckPage.errorText.nth(2).textContent)
    .contains(DOS_REQUIRED_MESSAGE)
...
test('Check properly filled form passes validation for an ineligible PHN', async (t) => {
  ...
  await t
    ...
    .eql('PORTFOLIOXE, ROISHANNXD ECKAXK')
    ...
    .expect(CoverageStatusCheckPage.clientInstructions.textContent)
...
test('Check Subsidy Insured Service CheckBox check and uncheck work', async (t) => {
  ...
  await t
    ...
    .expect(CoverageStatusCheckPage.subsidyInsuredServiceCheckBox.checked)
    .ok() //Confirm whether the option is selected
...
test('Check Date Of Last Eye Examination CheckBox check and uncheck work', async (t) => {
  ...
  await t
    ...
    .expect(CoverageStatusCheckPage.dateOfLastEyeExaminationCheckBox.checked)
    .ok() //Confirm whether the option is selected
...
test('Check clear button clears the form', async (t) => {
  ...
  await t
    ...
    .expect(CoverageStatusCheckPage.phnInput.value)
    .eql('')
    .expect(CoverageStatusCheckPage.dateOfBirthInput.value)
    .eql('')
    .expect(CoverageStatusCheckPage.subsidyInsuredServiceCheckBox.checked)
