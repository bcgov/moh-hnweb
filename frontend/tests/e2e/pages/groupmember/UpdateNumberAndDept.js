...
class UpdateNumberAndDept {
  constructor() {
    ...
    this.groupMemberOutput = Selector('#confirmation > ul > li').nth(0)
    this.phnOutput = Selector('#confirmation > ul > li').nth(1)
    this.groupMemberNumberOutput = Selector('#confirmation > ul > li').nth(2)
    this.departmentNumberOutput = Selector('#confirmation > ul > li').nth(3)
