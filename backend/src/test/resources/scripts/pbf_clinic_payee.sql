INSERT INTO pbf.pbf_clinic_payee (pbf_clinic_payee_id, archived, cancel_date, effective_date, payee_number, report_group) VALUES (10000, 'false', DATEADD(MONTH, 6, CURRENT_TIMESTAMP), DATEADD(YEAR, -23, CURRENT_TIMESTAMP), '00053', 'AAAA');
