...
public class MspContractsControllerTest extends BaseControllerTest {
	...
	public void testGetContractPeriods_success() throws InterruptedException {
        ...
        assertEquals("RPBS9014 TRANSACTION COMPLETED", getContractPeriodsResponse.getMessage());
        ...
        assertAffectedPartyCount(AffectedPartyDirection.OUTBOUND, 4);
	}
	...
	public void testGetContractPeriods_warning_moreThan20PersonsFound() throws InterruptedException {
        ...
        assertTransactionCreated(TransactionType.GET_CONTRACT_PERIODS);
        assertAffectedPartyCount(AffectedPartyDirection.INBOUND, 1);
        assertAffectedPartyCount(AffectedPartyDirection.OUTBOUND, 22);
	}
	...
	public void testContractInquiry_success() throws InterruptedException {
        ...
        assertEquals("RPBS9014 TRANSACTION COMPLETED", contractInquiryResponse.getMessage());
     ...
     // Check the client request is sent as expected
        ...
        assertAffectedPartyCount(AffectedPartyDirection.OUTBOUND, 2);
	}
	...
	public void testContractInquiry_warning_moreThan20PersonsFound() throws InterruptedException {
     ...
     // Check the client request is sent as expected
        ...
        assertTransactionCreated(TransactionType.CONTRACT_INQUIRY);
        assertAffectedPartyCount(AffectedPartyDirection.INBOUND, 2);
        assertAffectedPartyCount(AffectedPartyDirection.OUTBOUND, 20);
	}
	...
	public void testUpdateContractAddress_success() throws InterruptedException {
        ...
        assertEquals("RPBS9014 TRANSACTION COMPLETED", updateContractAddressResponse.getMessage());
