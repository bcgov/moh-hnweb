package ca.bc.gov.hlth.hnweb.utils.v2;
...
@SpringBootTest
public class V2MessageUtilsTest {
	...
	public void testSetMshValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setMshValues(r50Zo6.getMSH(), "HNWeb", "BC01000030", "RAIENROL-EMP", "BC00001013", "20200529114230", "10-ANother", "20200529114230", "D", "2.4");		
	...
	public void testSetZhdValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setZhdValues(r50Zo6.getZHD(), "20200529114230", "00000010", "HNAIADMINISTRATION", "2.4");		
	...
	public void testSetPidValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setPidValues(r50Zo6.getPID(), "9999999999", "BC", "PH", "", "19700303", "M");		
	...
	public void testSetZIAValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setZiaValues(r50Zo6.getZIA(), "20210101", "HELP^RERE^^^^^L", 
	...
	public void testSetIn1Values() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setIn1Values(r50Zo6.getIN1(), "6337109", "789446", "123456", "20190501", "20201231");		
	...
	public void testSetZihValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setZihValues(r50Zo6.getZIH(), "D");		
	...
	public void testSetZikValues() throws HL7Exception, IOException {
    	...
    	V2MessageUtils.setZikValues(r50Zo6.getZIK(), "20210101", "20221231");		
