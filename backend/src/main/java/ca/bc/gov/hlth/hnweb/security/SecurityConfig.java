...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .mvcMatchers(HttpMethod.GET, "/payee-mappings/").hasAnyRole("PatientRegistration", "ManageMSPPayeeNumber")
            .mvcMatchers(HttpMethod.POST, "/payee-mappings").hasRole("ManageMSPPayeeNumber")
            .mvcMatchers(HttpMethod.PUT, "/payee-mappings/").hasRole("ManageMSPPayeeNumber")
            .mvcMatchers(HttpMethod.DELETE, "/payee-mappings/").hasRole("ManageMSPPayeeNumber")
