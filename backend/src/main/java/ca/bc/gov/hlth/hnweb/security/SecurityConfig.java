...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            //inquire-contract endpoint will require this multi role when security is available as it is used by both R40 and R37 transactions -> hasAnyRole(TransactionType.CONTRACT_INQUIRY.getValue(), TransactionType.GET_GROUP_MEMBERS_CONTRACT_ADDRESS.getValue())
            .mvcMatchers(HttpMethod.POST, "/msp-contracts/inquire-contract").fullyAuthenticated() 
