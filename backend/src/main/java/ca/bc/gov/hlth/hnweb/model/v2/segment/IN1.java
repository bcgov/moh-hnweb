...
import ca.bc.gov.hlth.hnweb.model.v2.datatype.XONCustom;
 ...
 * <ul>
     ...
     * <li>IN1-11: Insured's Group Emp Name (XONCustom) <b>optional repeating</b>
...
public class IN1 extends AbstractSegment {
	...
	private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XONCustom.class, false, 0, 250, new Object[]{ getMessage() }, "Insured's Group Emp Name");
                                  ...
                                  this.add(AUI.class, false, 1, 250, new Object[]{ getMessage() }, "Authorization Information");
     ...
     */
    public XONCustom[] getInsuredSGroupEmpName() {
        XONCustom[] retVal = this.getTypedField(11, new XONCustom[0]);
    	return retVal;
    }
     ...
     * Returns all repetitions of Insured's Group Emp Name (IN1-11).
     */
    public XONCustom[] getIn111_InsuredSGroupEmpName() {
        XONCustom[] retVal = this.getTypedField(11, new XONCustom[0]);
    	return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public XONCustom getInsuredSGroupEmpName(int rep) { 
        XONCustom retVal = this.getTypedField(11, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public XONCustom getIn111_InsuredSGroupEmpName(int rep) { 
        XONCustom retVal = this.getTypedField(11, rep);
		return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XONCustom insertInsuredSGroupEmpName(int rep) throws HL7Exception { 
        return (XONCustom) super.insertRepetition(11, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XONCustom insertIn111_InsuredSGroupEmpName(int rep) throws HL7Exception { 
        return (XONCustom) super.insertRepetition(11, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XONCustom removeInsuredSGroupEmpName(int rep) throws HL7Exception { 
        return (XONCustom) super.removeRepetition(11, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XONCustom removeIn111_InsuredSGroupEmpName(int rep) throws HL7Exception { 
        return (XONCustom) super.removeRepetition(11, rep);
    }
	...
	protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 10: return new XONCustom(getMessage());
